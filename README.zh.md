...
| 扩展能力 | Extensions、skills、prompt templates、themes、packages | Phase 4 聚焦 RPC、SDK、extensions、skills、prompt fragments、themes 和 packages |
...
| Web UI | pi 的包集合中已有实现 | 等 RPC/SDK 表面可用后再实现 |
...
- 作为 extension/package 产品功能的子 Agent、permission gates、plan/todo 工作流与 skills。
- Prompt template registry。
- 通过 extension/package 路径接入 MCP 工具服务器。
- OAuth 或订阅登录流程。
