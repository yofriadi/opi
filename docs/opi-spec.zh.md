...
| 当前实现 | `opi` 0.6.0 workspace，第 8 阶段运行时稳定化已完成；第 7 阶段可靠性/可观测性和第 5 阶段 package/process-adapter 表面已存在 |
...
状态：当前 `0.6.0` workspace 中可扩展性基底已实现。
