...
| Current implementation | `opi` 0.6.1 workspace, Phase 8 runtime stabilization complete; Phase 7 reliability/observability and Phase 5 package/process-adapter surfaces are present |
...
Status: substrate implemented in the current `0.6.1` workspace.
...
Status: implemented in the current `0.6.1` workspace.
...
Status: complete in the current `0.6.1` workspace.
