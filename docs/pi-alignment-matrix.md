...
|---:|---|---|---|
| P0 | Documentation truth | Version and phase status must match `Cargo.toml` and `CHANGELOG.md`. | Current docs describe the `0.5.1` workspace and keep historical `0.5.0` rows historical. |
