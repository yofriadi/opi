...
| Never add unregistered design/plan docs, snapshot files, `CLAUDE.md`, `AGENTS.md`, or skill source to `spec_files` | Only reviewed supplemental source files listed in `skill.md` are normative for Phase 5-12 ledger drift checks. Arbitrary process docs and skill files create circular reinit failures. |
